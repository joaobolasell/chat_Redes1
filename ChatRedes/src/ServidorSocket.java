...
public class ServidorSocket extends Thread {
    ...
    private static Vector CLIENTES;  // Parte que controla as conexões por meio de threads.

    private Socket conexao; // socket deste cliente

    private String nomeCliente; // nome deste cliente

    private static List LISTA_DE_NOMES = new ArrayList(); // lista que armazena nome de CLIENTES
